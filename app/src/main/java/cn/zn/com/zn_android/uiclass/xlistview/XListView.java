package cn.zn.com.zn_android.uiclass.xlistview;
...
//    private static final String TAG = "XListView";
    ...
    //设置是否可向上拖拽
    private boolean dragLoadEnable = true;
...
//            mFooterView.setPadding(0, mFooterView.getHeight() * (-1), 0, 0);
     ...
     * 设置是否可向上拖拽
     *
     * @param pullLoadEnable
     */
    public void setDragLoadEnable(boolean pullLoadEnable) {
        this.dragLoadEnable = pullLoadEnable;
    }
     ...
     * @param enable
     */
    public void setRefreshTimeEnable(boolean enable) {
        if (mHeaderTime != null) {
            if (enable) {
                mHeaderTime.setVisibility(View.VISIBLE);
            } else {
                mHeaderTime.setVisibility(GONE);
            }
        }
    }
...
//        mScroller.startScroll(0, 0, 0, mHeaderHeight, 200);
        ...
        switch (ev.getAction()) {
            ...
            default:
                ...
                if (getFirstVisiblePosition() == 0) {
                    ...
                    // invoke load more.
                    if (mEnablePullLoad && mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA && loadMoreEnable) {
                        startLoadMore();
                    }
                    resetFooterHeight();
                }
    ...
    public void setLoadMoreEnableShow(boolean loadMoreEnable) {
        if (loadMoreEnable) mFooterView.setVisibility(VISIBLE);
        else mFooterView.setVisibility(GONE);
    }
