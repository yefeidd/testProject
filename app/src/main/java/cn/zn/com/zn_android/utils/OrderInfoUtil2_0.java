...
public class OrderInfoUtil2_0 {
     ...
     * @return
     */
    public static Map<String, String> buildOrderParamMap(String app_id, String timesTamp, String price) {
        Map<String, String> keyValues = new HashMap<String, String>();
...
//		keyValues.put("notify_url","http://tt.zhengniu.net/Api/Alipay/dd");
