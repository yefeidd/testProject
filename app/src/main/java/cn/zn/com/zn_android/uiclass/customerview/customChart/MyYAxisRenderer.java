       ...
       /*当有最小text的时候*/
        if (!TextUtils.isEmpty(mYAxis.getMinValue()) && mYAxis.isShowOnlyMinMaxEnabled()) {
            for (int i = 0; i < mYAxis.mEntryCount; i++) {
                ...
                if (i == 1) {
                    mAxisLabelPaint.setColor(mYAxis.getMaxColor());
                    c.drawText(text, fixedPosition, mViewPortHandler.offsetTop() + 2 * offset + 5, mAxisLabelPaint);
                } else if (i == 0) {
                    mAxisLabelPaint.setColor(mYAxis.getMinColor());
            ...
            for (int i = 0; i < mYAxis.mEntryCount; i++) {
                ...
                if (0 == i) mAxisLabelPaint.setColor(mYAxis.getMinColor());
                else mAxisLabelPaint.setColor(mYAxis.getMaxColor());
