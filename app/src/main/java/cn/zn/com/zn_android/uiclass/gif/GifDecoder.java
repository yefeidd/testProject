...
//	protected Bitmap image; // current frame
	...
	protected Bitmap setPixels(Bitmap image) {
		...
		try {
			...
			e.printStackTrace();
			Log.e("CreateBitmap", "setPixels: ", e);
		}
		return image;
	}
	...
	protected void readImage() {
		...
		try {
			...
			e.printStackTrace();
			Log.e("CreateBitmap", "readImage: ", e);
		}

		// createImage(width, height);
		image = setPixels(image); // transfer pixel data to image
	...
	protected void resetFrame(Bitmap image) {
		lastDispose = dispose;
		lrx = ix;
		lry = iy;
		lrw = iw;
