...
//    public final static String BASE_URL = "http://bate.zhengniu.net/";// 证牛正式网
...
//        public final static String BASE_URL = "http://www.98cfw.com";// 98财富网真实环境
    ...
    public final static String QUERY_GJB_LIST = "Api/Tcfw/tic_price_list"; // 高价榜列表
    ...
    public final static String GUESS_MARKET = "/index/guess.html";// 猜大盘页面
    public final static String ZNSYTK_URL = "/Index/zgsytk";// 投顾付费服务风险揭示及服务协议
