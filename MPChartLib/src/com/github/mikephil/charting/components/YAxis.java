...
public class YAxis extends AxisBase {
    ...
    /**
     * Color of the axisLeft
     */
    protected int mMaxColor = Color.GRAY;
    protected int mMinColor = Color.GRAY;
    /**
    ...
    /**
     * when true,axis labels are draw out side of the chart.
     * when false,axis labels are draw in side of the chart.
     */
    public boolean mShowOutSide = true;
    ...
    public void setShowOutSide(boolean mShowOutSide) {
        this.mShowOutSide = mShowOutSide;
    }
    ...
    public void setMinColor(int mMinColor) {
