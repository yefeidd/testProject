...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
    ...
    protected boolean mShowMarketEnable = true;
    /**
...
//        }
    ...
    public boolean isShowMarketEnable() {
        return mShowMarketEnable;
    }

    public void setShowMarketEnable(boolean mShowMarketEnable) {
        this.mShowMarketEnable = mShowMarketEnable;
    }
